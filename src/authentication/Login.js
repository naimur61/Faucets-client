    ...
    <Box sx={{
      ...
      >
        ...
        >
          ...
          <Button type="submit" fullWidth={true} variant="contained" sx={{ my: '20px' }}>Login</Button>
        </Box>
        <Box sx={{
          textAlign: 'center', fontWeight: 600, fontSize: '13px'
        }}>
          Don't have an account? <Link sx={{ color: "#9B1FE9", cursor: "pointer", textDecorationLine: 'none' }} onClick={() => navigate("/registration")}>Signup</Link>
        </Box>
        <Box sx={{
